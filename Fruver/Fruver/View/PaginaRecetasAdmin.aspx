<%@ Page Title="" Language="C#" MasterPageFile="~/View/MasterAdmin.master" AutoEventWireup="true" CodeFile="~/Controller/PaginaRecetasAdmin.aspx.cs" Inherits="View_PaginaRecetasAdmin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <section class="page-section about-heading position-relative d-block w-100" style="margin: 80px auto;">
        <div id="gv_cntr">
            <asp:GridView runat="server" ID="GV_Recetas" style="font-size:15px" class="grid_view four_columns_grid_view" AutoGenerateColumns="False" DataSourceID="ODS_Receta"  DataKeyNames="Id" >
                <Columns>
