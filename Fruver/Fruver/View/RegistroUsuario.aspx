                            ...
                            <div class="card w-100">
                                <div class="bg-faded rounded p-5" style=" display: block; width: 100%;">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="TB_Nombre" class="form-control float-left" Width="95%" runat="server" ValidationGroup="VG_RegistroUsuario" MaxLength="20"></asp:TextBox>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="TB_Username" class="form-control float-left" Width="95%" runat="server" ValidationGroup="VG_RegistroUsuario" MaxLength="30"></asp:TextBox>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="TB_Correo" class="form-control float-left" Width="95%" runat="server" ValidationGroup="VG_RegistroUsuario" TextMode="Email" MaxLength="30"></asp:TextBox>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="TB_Password" class="form-control float-left" Width="95%" runat="server" TextMode="Password" ValidationGroup="VG_RegistroUsuario" MaxLength="20"></asp:TextBox>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="TB_Direccion" class="form-control float-left" Width="95%" runat="server" ValidationGroup="VG_RegistroUsuario" MaxLength="30"></asp:TextBox>
