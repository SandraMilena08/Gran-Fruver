                            ...
                            <div class="card w-100">
                                <div class="bg-faded rounded p-5" style=" display: block; width: 100%;">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <asp:TextBox ID="TB_Username" class="form-control float-left" Width="95%" runat="server" ValidationGroup="VG_RegistroUsuario" MaxLength="30" AutoComplete="off" ValidateRequestMode="Disabled"></asp:TextBox>
                                        ...
                                        <asp:RegularExpressionValidator ID="RegularExpressionValidator4" runat="server" ControlToValidate="TB_Username" CssClass="auto-style1" ErrorMessage="Caracteres no validos" ValidateRequestMode="Disabled" ValidationExpression="^[a-zA-ZñÑ\s-A-Za-zäÄëËïÏöÖüÜáéíóúáéíóúÁÉÍÓÚÂÊÎÔÛâêîôûàèìòùÀÈÌÒÙ.,-]+$"></asp:RegularExpressionValidator>
                                    </div>
                                    <div class="form-group">
